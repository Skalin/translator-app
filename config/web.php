...
return [
    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ['class' => 'yii\rest\UrlRule', 'controller' => 'api/lang', 'tokens' => [
                    '{id}' => '<id:\\w+>',
                ]],
                ['class' => 'yii\rest\UrlRule', 'controller' => 'api/translation', 'tokens' => [
                    '{id}' => '<id:\\w+>',
                ]],
                ['class' => 'yii\rest\UrlRule', 'controller' => 'api/export', 'tokens' => [
                    '{id}' => '<id:\\w+>',
                ]],
            ],
        ],
